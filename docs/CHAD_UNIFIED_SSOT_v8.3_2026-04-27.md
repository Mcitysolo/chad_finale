...
**Supersedes:** `docs/CHAD_UNIFIED_SSOT_v8.2_2026-04-26.md` (commit `accaa2b`, 2026-04-26)
...
| Date written | 2026-04-27 (UTC) |
| Predecessor | v8.2 — `docs/CHAD_UNIFIED_SSOT_v8.2_2026-04-26.md` (`accaa2b`) |
| Repository HEAD at write time | `1608fec` — *"Build: business framework foundation files"* |
| Branch | `main` |
...
### This session's commit chain (4 commits since v8.2)

In topological order (oldest → newest):

1. **`15677a2`** — *Fix: enforce Kraken REST pair format at executor +
   ...
   (altname, valid).
2. **`0c3a3e1`** — *Fix: exclude broker_sync from weekly top brain
...
3. **`1caa111`** — *Build: complete CHAD business framework
...
4. **`1608fec`** — *Build: business framework foundation files*
...
| `portfolio_risk_cap` | `$8,363.37` | `runtime/dynamic_caps.json:portfolio_risk_cap` (= equity × 0.05 with profit-lock factor) |
...
Total `chad-*` units loaded: **53** (services + timers).
Active (running): **13** services. Failed: **0**.
...
| Weight | 0.20 |
| Base cap | `$1,672.67` |
| **Final dollar cap** | **`$1,672.67`** (largest single dollar cap in the book) |
| tier_factor | `1.0` |
| winner_factor | `1.0` |
| regime_factor | `1.0` |
| Active in | `trending_bull, trending_bear, volatile, unknown` |
