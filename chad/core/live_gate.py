...
def evaluate_live_gate() -> LiveGateDecision:
    ...
    # Gate 5: SCR
    if shadow.paper_only or shadow.state.upper() == "PAUSED":
        gates.append(
            GateResult(
                name="SCR",
                passed=False,
